import 'package:bfn_anchor_app_repo/bloc/anchor_bloc.dart';
import 'package:bfn_anchor_app_repo/ui/welcome.dart';
...
//        title: Text('Offers')));
  ...
  Widget build(BuildContext context) {
    final AnchorBloc bloc = prov.Provider.of<AnchorBloc>(context);
    _anchorBloc = bloc;
    var node = bloc.node;
    print(node);
